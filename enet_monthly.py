...
def main():
    ...
    #pd.pprint(common_dict)
    (event_dict, nonevent_dict) = event_cal(common_dict)
    #pd.pprint(event_dict)
    out_html(event_dict, nonevent_dict)

def event_cal(common_dict):
    event_dict = {}
    nonevent_dict = {}
    ...
    return (event_dict, nonevent_dict)

def out_html(event_dict, nonevent_dict):
